            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <?php
                        $jdate = '2021-12-23';
                        $join = date_create($employ['tanggal_join']);
                        ...
                        $month = $diff->m;
                        if ($employ['tanggal_join'] <= $jdate) {
                            // jka sudah 6 bulan baru munculkan cuti nya
                            if ($diff >= 6) {
                                echo 'Jatah Cuti anda' . $month . ' Hari';
                            } else {
                                echo 'Belum ad jatah cuti';
                            }
                        } else {
                            //jika sudah 1 tahun baru munculkan cuti nya
                                    ...
                                    <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="widget-title">Input Permit ( <?= $employ['employee_name'] ?> )</h4>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-xs-2">
                                                                ...
                                                                <select class="form-control" id="form-field-select-1" name="type" required>
                                                                    ...
                                                                    <option value="3">SKB</option>
                                                                    <option value="4">ISOMAN</option>
                                                                    <?php
                                                                    if ($employ['status_kawin'] != 'S') {
                                                                        echo "<option value=5>MELAHIRKAN</option>";
                                                                    } else { }
                                                                    ?>
                                                                    <?php
                                                                    if ($y > 0) {
                                                                        echo "<option value=6>TAHUNAN</option>";
                                                                    } else { }
                                                                    ?>
                                                                    <option value="7">BERDUKA</option>
                                                                    <option value="8">ACARA KEAGAMAAN</option>
                                                            ...
                                                            <div class="form-group col-xs-2">
                                                                ...
                                                                <input type="hidden" name="employeeID" class="width-100" value="<?= $employ['id'] ?>">
                                                            </div>
