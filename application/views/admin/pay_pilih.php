                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="blue" href="<?= base_url('admin/payment_detail/' . $emp['id'] . '/' . $emp['bulanangka'] . '/' . $emp['year']) ?>" target="_blank">
                                                                <i class="ace-icon fa fa-money bigger-130"></i>
                                                            </a>
                                                            <a class="green" href="<?= base_url('admin/paymentchose/' . $emp['id'] . '/' . $emp['bulanangka'] . '/' . $emp['year']) ?>" target="_blank">
