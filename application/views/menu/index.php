                        ...
                        <tbody>
                            ...
                            foreach ($menu as $m) : ?>
                                <tr>
                                    ...
                                    <td class="center"><?= $m['menu'] ?></td>
                                    <td class="center">
                                        <a href="<?= base_url('menu/update_data/' . $m['id']) ?>">
                                            <button class="btn btn-xs btn-success">
                                                <i class="ace-icon fa fa-pencil bigger-120"></i>
                                            </button>
                                        </a>
                                        <a onclick="return confirm('Yakin ingin menghapus ?')" href="<?= base_url('menu/delete_data/' . $m['id']) ?>">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <form class="form-horizontal" role="form" action="<?= base_url('menu') ?>" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" id="menu" name="menu" placeholder="Menu Name" class="col-xs-12 col-sm-12" />
                        </div>
                    </div>
                </div>
